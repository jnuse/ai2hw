...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"智能职场助手","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 30 */
/*!*************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/utils/storage.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 带过期时间的存储
var setStorageWithExpire = function setStorageWithExpire(key, value) {
  var expireHours = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 24;
  var data = {
    value: value,
...
// 获取存储数据，自动处理过期情况
var getStorageWithExpire = function getStorageWithExpire(key) {
  var dataStr = uni.getStorageSync(key);
...
var user = {
  ...
  setUserInfo: function setUserInfo(userInfo) {
    uni.setStorageSync(_config.default.USER_INFO_KEY, userInfo);
  },
  // 获取用户信息
  getUserInfo: function getUserInfo() {
    return uni.getStorageSync(_config.default.USER_INFO_KEY);
  },
  // 清除用户信息
  clearUserInfo: function clearUserInfo() {
    uni.removeStorageSync(_config.default.USER_INFO_KEY);
...
var chat = {
  // 保存聊天记录
  saveChat: function saveChat(chatId, messages) {
    var chats = uni.getStorageSync('chatHistory') || {};
    chats[chatId] = {
      messages: messages,
      updateTime: Date.now()
    };
  ...
  getChatList: function getChatList() {
    var chats = uni.getStorageSync('chatHistory') || {};
    return Object.keys(chats).map(function (id) {
      var chat = chats[id];
      // 获取第一条消息作为标题
      var title = chat.messages && chat.messages.length > 0 ? chat.messages[0].content.slice(0, 20) : '新对话';
      return {
        id: id,
        title: title,
...
/* 31 */
/*!******************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/config.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 根据环境选择配置
var ENV = "development";
var config = ENV === 'production' ? PROD_CONFIG : DEV_CONFIG;
var _default = {
  // 应用名称
  APP_NAME: '智能职场助手',
  // API基础URL
...
/* 41 */
/*!*************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/utils/request.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
// API基础URL，从配置文件中获取
var BASE_URL = _config.default.BASE_API;

// 请求拦截器
var beforeRequest = function beforeRequest(options) {
  // 获取token
...
var request = function request(options) {
  var config = beforeRequest(options);
  return new Promise(function (resolve, reject) {
    uni.request({
