...
/***/ 44:
/*!***********************************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/main.js?{"page":"pages%2Fchat%2Fchat"} ***!
  \***********************************************************************************/
...
var _chat = _interopRequireDefault(__webpack_require__(/*! ./pages/chat/chat.vue */ 45));
// @ts-ignore
...
/***/ 45:
/*!****************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue ***!
  \****************************************************************/
/*! no static exports found */
...
/* harmony import */ var _chat_vue_vue_type_template_id_bf16e7f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.vue?vue&type=template&id=bf16e7f4& */ 46);
/* harmony import */ var _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.vue?vue&type=script&lang=js& */ 48);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _chat_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.vue?vue&type=style&index=0&lang=css& */ 50);
...
/***/ 46:
/*!***********************************************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=template&id=bf16e7f4& ***!
  \***********************************************************************************************/
...
/***/ 47:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=template&id=bf16e7f4& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 48:
/*!*****************************************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 49:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  onLoad: function onLoad(options) {
    ...
    if (options.recordId) {
      ...
      this.messageList = [{
        sender: 'assistant',
        content: "\u60A8\u597D\uFF0C".concat(this.username, "\uFF01\u6211\u662F\u60A8\u7684\u667A\u80FD\u804C\u573A\u52A9\u624B\uFF0C\u8BF7\u95EE\u6709\u4EC0\u4E48\u53EF\u4EE5\u5E2E\u60A8\u7684\uFF1F")
      }];
    }
  },
  methods: {
    // 加载示例问题
    loadExampleQuestions: function loadExampleQuestions() {
      var _this = this;
      _request.default.get('/examples').then(function (res) {
        _this.exampleQuestions = res || [];
      }).catch(function (err) {
        console.error('获取示例问题失败:', err);
        // 使用默认示例问题
        _this.exampleQuestions = ['如何提高工作效率？', '职场中如何处理人际关系？', '如何准备晋升答辩？', '如何优化我的简历？', '如何进行有效的时间管理？'];
      });
    },
    updateNavbarTitle: function updateNavbarTitle() {
      // 格式化当前日期时间
      var now = new Date();
      ...
      this.navbarTitle = "".concat(year, "-").concat(month, "-").concat(day, " ").concat(hours, ":").concat(minutes);
    },
    ...
    sendMessage: function sendMessage() {
      ...
      // 添加临时消息，表示正在思考
      var thinkingIndex = this.messageList.length;
      this.messageList.push({
        sender: 'assistant',
        content: '思考中...'
      });
      ...
      // 调用聊天API
      _request.default.post('/chat', {
        message: userMessage,
        conversationId: this.conversationId
      }).then(function (res) {
        // 更新会话ID - 非常重要，确保后续消息能关联到同一对话
        _this2.conversationId = res.record_id;

        // 替换"思考中"消息
        _this2.messageList.splice(thinkingIndex, 1, {
          sender: 'assistant',
          content: res.reply
        });
        ...
        _this2.messageList.splice(thinkingIndex, 1, {
          sender: 'assistant',
          content: "\u62B1\u6B49\uFF0C\u53D1\u751F\u4E86\u9519\u8BEF\uFF1A".concat(err.message || '未知错误')
        });
      }).finally(function () {
    ...
    scrollToBottom: function scrollToBottom() {
      this.scrollToView = "msg-".concat(this.messageList.length - 1);
    },
    loadHistoryConversation: function loadHistoryConversation(recordId) {
      var _this3 = this;
      uni.showLoading({
        title: '加载中...'
      });
      ...
      // 调用API获取历史对话详情
      _request.default.get("/history/".concat(recordId)).then(function (res) {
        console.log('历史记录详情:', res); // 调试日志，查看返回的数据结构

        if (res && res.content) {
          // 解析对话内容
          _this3.parseHistoryContent(res.content);

          // 设置标题，可选
          if (res.title) {
            // 更新导航栏标题，显示对话标题
            _this3.navbarTitle = res.title;
          }
        } else {
          uni.showToast({
            title: '历史记录内容为空',
    ...
    // 解析历史对话内容为消息列表
    parseHistoryContent: function parseHistoryContent(content) {
      var _this4 = this;
      if (!content) {
        this.messageList = [];
        return;
    ...
    navigateToChat: function navigateToChat() {
      // 已经在聊天页面，不需要跳转
    },
    navigateToHistory: function navigateToHistory() {
      uni.navigateTo({
        url: '/pages/history/history'
      });
    },
    // 显示问题示例
    showExamples: function showExamples() {
      this.showExamplesList = true;
    },
    // 选择问题示例
    selectExample: function selectExample(question) {
...
/***/ 50:
/*!*************************************************************************************************!*\
  !*** D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 51:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/workplace/pythonLab/ws/ai2hw/智能助手/pages/chat/chat.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
