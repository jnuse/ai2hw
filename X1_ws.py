...
if __name__ == '__main__':
    ...
    appid = "d18bd9cc"  # 填写控制台中获取的 APPID 信息
    api_secret = "YzRkYzE2NDVlYmU4ZWVmOWE3YmRlNThh"  # 填写控制台中获取的 APISecret 信息
    api_key = "7d0f8e88c05af5caf9397bce00b227ac"  # 填写控制台中获取的 APIKey 信息
    domain = "x1"       #控制请求的模型版本
    # 服务地址
